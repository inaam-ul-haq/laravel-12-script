<x-layouts.auth>
    <x-slot name="pageTitle">{{__('language.edit')}} {{$data->title}}</x-slot>
    @push('auth_styles')
    <style>
        .big-checkbox {
            width: 20px;
    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <x-auth.card card-header="{{__('language.edit')}} {{$data->title}}">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <x-auth.input-field type="text" name="title" id="title"
                                place="{{__('language.title_label')}}" val="{{ $data->title }}" required="true"
                                label="{{__('language.role_title_label')}}" />
                        </div>
                        ...
                        <div class="col-md-12">
                            <x-auth.input-button btn-class="mt-3 btn-primary" btn-value="{{__('language.edit')}}"
                                btn-type="submit" />
                        </div>
                    </div>
                </x-auth.form>
